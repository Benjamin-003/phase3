...
Ce projet propose une solution algorithmique pour l'ordonnancement automatisé d'analyses médicales au sein d'un laboratoire. L'objectif est d'optimiser l'utilisation des ressources humaines (techniciens) et matérielles (équipements) tout en garantissant le respect strict des priorités médicales. 

Le système résout la problématique complexe de la synchronisation entre la disponibilité des échantillons, les compétences spécifiques des techniciens et les cycles de maintenance/nettoyage des machines.
...
4.  Le résultat de la planification ainsi que les indicateurs de performance seront générés dans le fichier : `/output/output-example.json`.
...
## Formats des Données Attendus (/data)

### Échantillons
Le système attend un fichier JSON listant les analyses à effectuer avec leur niveau de priorité et leur heure d'arrivée.

### Techniciens & Équipements
Les techniciens doivent posséder des compétences spécifiques et un coefficient d'efficacité, tandis que les équipements définissent des temps de nettoyage obligatoires.

---

## Indicateurs de Performance (KPIs)

Le fichier de sortie inclut une analyse détaillée de l'efficacité du planning :

* **Temps d'attente moyen** : Calculé par catégorie de priorité.
* **Taux d'utilisation** : Mesure de la charge de travail des techniciens et des machines.